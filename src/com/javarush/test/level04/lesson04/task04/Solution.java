...
public class Solution
{
    ...
    public static void checkSeason(int mount){
        ...
        if (mount==3 | mount==4 | mount==5) System.out.println("весна");
        if (mount==6 | mount==7 | mount==8) System.out.println("лето");
        if (mount==9 | mount==10 | mount==11) System.out.println("осень");
    }
}