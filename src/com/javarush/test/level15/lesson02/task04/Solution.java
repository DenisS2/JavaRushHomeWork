...
public class Solution {
    ...
    public abstract static class Book {
        ...
        private String getOutputByBookType() {
            ...
            if (author=="Agatha Christie") output=agathaChristieOutput;
            if (author=="Mark Twain") output=markTwainOutput;
            //Book book=getBook();
            //if (book instanceof AgathaChristieBook) output=agathaChristieOutput;
            //if (book instanceof MarkTwainBook) output=markTwainOutput;
            return output;
        }
